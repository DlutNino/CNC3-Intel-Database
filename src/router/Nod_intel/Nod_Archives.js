...
const archives = [
    {
        ...
        props: {
            ...
            translation: [
                ...
                '当由富裕国家勾结而成的，被称作全球防御组织的法西斯政治联盟试图掌控这神圣的绿色水晶时，兄弟会昼夜不停不知疲倦地四处收集珍贵水晶的样品......为了研究它，发掘它作为一种新能源的潜力，探索它的无限可能性。' +
                '无论基于我们的研究成果还是源于我们的崇高信仰，我们都深信无疑，泰伯利亚就是赐予人类的终极礼物。' +
                '它是通往未来的钥匙。',
    ...
    },
    {
        ...
        props: {
            ...
            tr_source: '【来自 一本黄区信息手册】',
            or_source: 'From a Yellow Zone information pamphlet',
    ...
    },
    {
        ...
        props: {
            ...
            translation: [
                '长期以来，核心集团对于GDI对外太空的支配地位都怀有极大的恐惧。' +
                'GDI的轨道武器平台，指挥与控制空间站和间谍卫星被强大的反导弹系统所严密守护着，似乎无懈可击，不可战胜。' +
                '这条运行于轨道的死亡之链是基于一张由天基动能杀伤武器、激光甚至离子炮本体组成的网络——用于拦截和摧毁来袭的导弹。' +
                '多年以来，GDI在太空中的军备始终令兄弟会感到遥不可及，这导致了一种感觉的产生，那就是数十年斗争中双方力量的平衡最终会决定性地倒向不利于兄弟会的一边。',
                '但是我们的特工捕捉到了GDI系统中的一个瑕疵：出于某种难以琢磨的原因，GDI将他们的离子炮和A-SAT系统的操作人员和控制中心都安置在了地面上。' +
                '更令我们欣喜的是，这些关键的人员和设备都集中在东北部蓝区的一座独立设施内。' +
                '我们经过深思熟虑制定了一个周密的计划，对戈达德航天中心发动突然袭击，如果成功，可能会导致GDI的所有离子炮及整个A-SAT系统全部处于离线状态，这将给予兄弟会几天甚至几周的时间在全球范围内安排作战行动，而不受天基武器和电子千里眼的阻碍。',
