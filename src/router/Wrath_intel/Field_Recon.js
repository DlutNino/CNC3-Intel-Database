...
const field_recon = [
    {
        ...
        props: {
            ...
            translation: [
                ...
                '仅去年一年，你就失去了24名左右的工作人员，而且你非常清楚，他们不是平庸的帮你拿烧杯的助手，他们都是泰伯利亚领域的顶尖科学家，学识渊博，无可取代。' +
                '杰克，你并须明白，大家真的只是不想为你工作，不想被已经发生的这些事情波及到，不管我们在他们的工资簿上加多少个0都无济于事。',
                '我知道你从液态的泰伯利亚中看到了许多可能性，我也真的要对你的激情表示赞扬，但现在对于议会中那些严重怀疑这一研究项目是否会白白赔上数十亿钱款和许多条生命的人，我开始站在他们一边了。',
            ...
            tr_source: '截获一条关于澳大利亚秘密液态泰伯利亚科研项目的GDI通讯<br/><br/>致：澳大利亚GDI泰伯利亚研究所主席 詹姆斯-德格鲁特博士<br/><br/>寄：美国华盛顿特区秘密研发局主任 艾略特-史密斯-约翰逊<br/><br/>主题：又一次爆炸？！',
            tr_remark: '此通讯由黑手教长 卢修斯-比卡 截获',
            or_source: 'Intercepted GDI Transmission regarding secret Liquid Tiberium research in Australia<br/><br/>To: Dr. James De Groot, Chair, GDI Institute for Tiberium Research, [Redacted], Australia<br/><br/>From: Eliot Smith-Johnson, Director, Department of Covert R&D, Washington DC, USA<br/><br/>Subject: Another explosion?!',
            or_remark: 'Intercepted by Black Hand Prelate Lucius Bika',
            pic_src: require('../../assets/wrath_pictures/IDB_Tiberium_diagram.png'),
        },
    },
    {
        path: 'tacitus',
        ...
        props: {
            ...
            translation: [
                '塔西佗是一座来自外星，起源年代未知的档案库，是“升天”预言的关键所在，是凯恩建立Nod兄弟会的核心信义。' +
                '自两年前从Nod手中夺回该设备以来，它一直被存放在GDI的夏延山军事要塞群中，保持安全状态，据说此前凯恩已经想方设法地从塔西佗中提取出了若干信息。' +
                '第二次泰伯利亚战争结束时，这些数据随Nod一同销声匿迹，这导致我们没有任何确凿的证据来证明所谓的先知到底想要用塔西佗来做些什么。',
                '鉴于在过去三年中Nod的活动少之又少，我们只能断定他的计划碰壁了。',
            ...
            tr_source: '截获一条GDI短情报',
            tr_remark: '此简报由 Nod情报部门 取得',
