...
const weaponry = [
    {
        ...
        props: {
            ...
            translation: [
                ...
                '为了巩固自己作为一个“纯粹”的本教信仰者的形象，标榜自己没有受到其前任的所谓异端的玷污，马西昂采取了激进措施，用一大批做好战斗准备的圣徒取代了标准编制下的Nod武装分子先遣队，这些圣徒装备有机枪和内含精神药物的致幻手榴弹，可以更有效地传播他的意志......并将他的敌人置于刀剑之下。',
            ],
            original: [
    ...
    },
    {
        ...
        props: {
            ...
            translation: [
                '在第二次泰伯利亚战争的余波中，GDI中止了耗资无数、风险极高的悬浮科技计划方案，而GDI弹弓则是个幸运儿——作为这项曾在GDI诸多项目中占主导地位的计划的最后成果，它在经历了长达十年的开发过程后，最终成功结束测试，投入实战。',
                '与此前的同类单位相比，这种专门用于防空的战车对离子风暴干扰的抗性更强，但相对而言弹弓仍然比较脆弱——它牺牲了装甲和副武器，换取了迅捷的速度、良好的机动性和性能优越的四管火炮，即使是最强劲的空中对手，也会在弹弓的火力下颓然坠地。',
            ],
            original: [
    ...
    },
    {
        ...
        props: {
            ...
            translation: [
                '作为20世纪的突击/运输综合性武装直升机的后继者，大型重装直升机锤头鲨的设计定位是弥补奥卡攻击机的短板，奥卡的活动范围相对较为有限，因此GDI需要一种用于远途作战的飞行器。',
                '锤头鲨装备有多门火神炮，其内部空间足以运送一整个步兵团，它的秘密武器是巨大的补给存储量，足以支撑它在战场上连续数日执行任务，无需加油或重新进行武装。',
            ],
            original: [
    ...
    },
    {
        ...
        props: {
            ...
            translation: [
                '作为GDI军械库中不可或缺的一份子，神像机动火炮步行机甲有一个短板，那就是武器有效载荷不足，在短兵相接贴近对抗时无计可施。' +
                '有太多太多的神像被人数不超过一个步兵团的Nod部队所针对，化为一片灰烬，一个GDI工程兵团对此感到万分沮丧，于是他们进行尝试，在机甲的底座上加装了一个可以进驻步兵的吊舱。',
                '这一奇思妙想最终大获成功，不必多说，遭遇改装机甲的Nod巡逻部队的下场极为悲惨，于是改进版神像取得了“巨兽”的昵称，在不久之后被批准进行全面开发。' +
                '经过钢爪部队一段时间的实战测试之后，巨兽有望成为全球的GDI远程炮兵部队的顶梁柱。',
            ],
            original: [
    ...
    },
    {
        ...
        props: {
            ...
            translation: [
                ...
                '钢爪收割机没有装备标准配置的旋转式机枪，而是拥有一个可以进驻步兵的吊舱，可以根据指挥官的判断和命令来应对各种各样的危险和威胁。',
            ],
            original: [
